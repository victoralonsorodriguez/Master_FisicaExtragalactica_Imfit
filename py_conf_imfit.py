...
def create_conf_imfit(file,funct,galaxy,img_center_x,img_center_y,pos_ang,ellip,
                     n=[None,None,None],I_e=[None,None,None],r_e=[None,None,None], # Sersic
                     I_0=[None,None,None],h=[None,None,None],                      # Exponential
                     n_bar=[None,None,None],a_bar=[None,None,None],c0=[None,None,None]): # Ferrer
